...
#define FCSM_STDIN_SHARING FILE_SHARE_WRITE
#define FCSM_STDIN_DISPOSITION OPEN_EXISTING
#define FCSM_STDIN_FLAGS FILE_ATTRIBUTE_NORMAL
#define FCSM_STDOUT_SHARING (FILE_SHARE_READ | FILE_SHARE_WRITE)
#define FCSM_STDOUT_DISPOSITION OPEN_ALWAYS
#define FCSM_STDOUT_FLAGS FILE_ATTRIBUTE_NORMAL
#define FCSM_STDERR_SHARING (FILE_SHARE_READ | FILE_SHARE_WRITE)
#define FCSM_STDERR_DISPOSITION OPEN_ALWAYS
#define FCSM_STDERR_FLAGS FILE_ATTRIBUTE_NORMAL
...
int get_output_handles(fcsm_service_t *, STARTUPINFO *);
int use_output_handles(fcsm_service_t *, STARTUPINFO *);
void close_output_handles(STARTUPINFO *);
void cleanup_loggers(fcsm_service_t *);
