...
typedef int (*walk_function_t)(fcsm_service_t *, kill_t *);

HANDLE get_debug_token();
void service_kill_t(fcsm_service_t *, kill_t *);
...
int kill_threads(fcsm_service_t *, kill_t *);
int kill_threads(kill_t *);
int kill_console(fcsm_service_t *, kill_t *);
int kill_console(kill_t *);
int kill_process(fcsm_service_t *, kill_t *);
int kill_process(kill_t *);
int print_process(fcsm_service_t *, kill_t *);
int print_process(kill_t *);
void walk_process_tree(fcsm_service_t *, walk_function_t, kill_t *, unsigned long);
