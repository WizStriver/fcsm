...
#define FCSM_LOCALSYSTEM_ACCOUNT _T("LocalSystem")
/* Other well-known accounts which can start a service without a password. */
#define FCSM_LOCALSERVICE_ACCOUNT _T("NT Authority\\LocalService")
#define FCSM_NETWORKSERVICE_ACCOUNT _T("NT Authority\\NetworkService")
/* Virtual service accounts. */
#define FCSM_VIRTUAL_SERVICE_ACCOUNT_DOMAIN _T("NT Service")
/* This is explicitly a wide string. */
#define FCSM_LOGON_AS_SERVICE_RIGHT L"SeServiceLogonRight"
