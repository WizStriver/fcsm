...
#define FCSM_KERNEL_DRIVER _T("SERVICE_KERNEL_DRIVER")
#define FCSM_FILE_SYSTEM_DRIVER _T("SERVICE_FILE_SYSTEM_DRIVER")
#define FCSM_WIN32_OWN_PROCESS _T("SERVICE_WIN32_OWN_PROCESS")
#define FCSM_WIN32_SHARE_PROCESS _T("SERVICE_WIN32_SHARE_PROCESS")
#define FCSM_INTERACTIVE_PROCESS _T("SERVICE_INTERACTIVE_PROCESS")
#define FCSM_SHARE_INTERACTIVE_PROCESS FCSM_WIN32_SHARE_PROCESS _T("|") FCSM_INTERACTIVE_PROCESS
#define FCSM_UNKNOWN _T("?")

#define FCSM_ROTATE_OFFLINE 0
#define FCSM_ROTATE_ONLINE 1
#define FCSM_ROTATE_ONLINE_ASAP 2
...
void set_fcsm_service_defaults(fcsm_service_t *);
void cleanup_fcsm_service(fcsm_service_t *);
...
int pre_install_conf_service(TCHAR **);
int create_service_conf_template(TCHAR **);
int pre_remove_service(int, TCHAR **);
int pre_edit_service(int, TCHAR **);
int install_service(fcsm_service_t *, bool editing=false);
int remove_service(fcsm_service_t *);
int edit_service(fcsm_service_t *, bool);
int control_service(unsigned long, int, TCHAR **, bool);
int control_service(unsigned long, int, TCHAR **);
void set_service_recovery(fcsm_service_t *);
int monitor_service(fcsm_service_t *);
int start_service(fcsm_service_t *);
int stop_service(fcsm_service_t *, unsigned long, bool, bool);
void CALLBACK end_service(void *, unsigned char);
void throttle_restart(fcsm_service_t *);
int await_single_handle(SERVICE_STATUS_HANDLE, SERVICE_STATUS *, HANDLE, TCHAR *, TCHAR *, unsigned long);
int list_fcsm_services(int, TCHAR **);
